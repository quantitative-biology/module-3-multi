...
```{r ordreg, fig.wdith=7,fig.cap="Diagram showing the differences between uncontrained ordination, multiple regression and constrained ordination", fig.alt=""}
par(mar=c(0,0,0,0))
...
```{r lichenCOR, echo=TRUE, fig.caption="Correlations between environmental variables", fig.alt=""}
