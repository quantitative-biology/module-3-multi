...
```{r dimred, fig.height=5., fig.width=5., echo=FALSE,fig.cap="Ordination as data reduction. We summarize data with many (p) variables by a smaller set of derived or synthetic variables", fig.alt=""}
par(mar = c(0, 0, 0, 0))
