...
BEWARE: many things are called rda in R that have nothing to do with ordination!! You will see that we specify the vegan package when calling rda in the code in order to avoid confusion.
