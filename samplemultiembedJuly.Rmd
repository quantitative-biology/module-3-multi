...
```{r f2, echo=FALSE, fig.cap="Euclidean Distance", fig.alt="The graph shows a line between two sample points k and j, representing the abundance between species 1 and species 2. Two new lines perpendicular to x and y axes starting from points k and j are constructed."}
x=c(19, 35)
y=c(30, 10)
...
>>>>>>> 00f509be89dc92044f48111c1052aae2b38baa60
