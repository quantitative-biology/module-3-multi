...
```{r ordreg, fig.wdith=7,fig.cap="Diagram showing the differences between uncontrained ordination, multiple regression and constrained ordination", fig.alt="This figure shows the differences between unconstrained ordination, multiple regression and constrained ordination. The top left of the figure has title 'Simple ordination:PCA/CA' and is represented by a box with label 'matrix Y' in the middle. The box has label 'Variables y1...yp' at the top and 'Objects 1 to n' on the left. The top right of the figure has title 'Multiple regression' and is represented by two boxes placed side by side and a double sided arrow that connects them. The left rectangle has text 'y' in the middle with label 'Variable y' at the top of the box and 'Objects 1 to n' on the left. The right triangle is labelled 'Matrix X' with 'Variables x1 ... xm' at the top. The bottom of the figure has title 'Ordination under constraint:RDA/CCA' and is represented by two boxes placed side by side and a double sided arrow that connects them. The left box has label 'matrix Y' in the middle of the box with 'Variables y1 ... yp' at the top and 'Objects 1 to n' to the left. The right box has label 'matrix X' at the center and 'Variables x1 ... xm' at the top."}
par(mar=c(0,0,0,0))
